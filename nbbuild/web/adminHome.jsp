...
<title>NITRR</title>
<body>
<img src="logo1.png"  align="left"width="100" height="100">
<center> <h1 style="width: 70% ">NITRR</h1>
<img src="apj sir.png" style="margin-top: -4rem;" align="right"  width="150" height="150" top="10"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Problem Solving and Programming</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Computer System Architecture</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Professional Communication in English</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Computer Oriented Numerical Analysis</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Computer Lab-101</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Computer Lab-102</label>
                                    <div class="col-md-6">
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          ...
          <th>Computer Oriented Numerical Analysis</th>
          <th>Computer Lab-101</th>
          <th>Computer Lab-102</th>
        </tr>
      </thead>
    </table>
  </div>
